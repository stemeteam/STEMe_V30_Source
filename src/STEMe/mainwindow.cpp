    ...
    ui(new Ui::MainWindow)
{
    ...
    this->reConnectModbus();
    this->setGeometry(mainWindow_LocalX,mainWindow_LocalY,mainWindow_Width,mainWindow_Height);
...
void MainWindow::reConnectModbus()
{
   ...
   // QMessageBox::information(this,"info",dev.serialNumber(),QMessageBox::Ok);
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        case VDevice::GSoftwareAccount:
            ...
            m_frmUserAccount->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmUserAccount->width()),\
                                  this->getLocal_Y(ui->tabWidget->geometry(),m_frmUserAccount->height()),m_frmUserAccount->width(),m_frmUserAccount->height());
        ...
        case VDevice::GSoftwareAddDevice:
            ...
            m_frmAddNewDevice->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmAddNewDevice->width()),\
                                      this->getLocal_Y(ui->tabWidget->geometry(),m_frmAddNewDevice->height()),m_frmAddNewDevice->width(),m_frmAddNewDevice->height());
        ...
        case VDevice::GSoftwareSetting:
            ...
            m_frmsettingDevice->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmsettingDevice->width()),\
                                      this->getLocal_Y(ui->tabWidget->geometry(),m_frmsettingDevice->height()),m_frmsettingDevice->width(),m_frmsettingDevice->height());
    ...
    case VDevice::GSensorSEN0101:
        ...
        m_frmSEN0101->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0101->width()),\
                                      this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0101->height()),m_frmSEN0101->width(),m_frmSEN0101->height());
        m_frmSEN0101->show();
        break;
    case VDevice::GSensorSEN0102:
        ...
        m_frmSEN0102->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0102->width()),\
                                      this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0102->height()),m_frmSEN0102->width(),m_frmSEN0102->height());
        m_frmSEN0102->show();
        break;
    case VDevice::GSensorSEN0103:
        /*if(m_frmSEN0103)delete m_frmSEN0103;
        m_frmSEN0103 = new Sensor_SEN0103();
        m_frmSEN0103->setDeviceWidget(dev,m_userLogin);
        m_frmSEN0103->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0103->width()),\
                                      this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0103->height()),m_frmSEN0103->width(),m_frmSEN0103->height());
        m_frmSEN0103->show();*/
        ...
        m_frmMSG1101->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmMSG1101->width()),\
                                      this->getLocal_Y(ui->tabWidget->geometry(),m_frmMSG1101->height()),m_frmMSG1101->width(),m_frmMSG1101->height());
        m_frmMSG1101->show();
        break;
    case VDevice::GSensorSEN0104:
        ...
        m_frmSEN0104->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0104->width()),\
                                      this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0104->height()),m_frmSEN0104->width(),m_frmSEN0104->height());
        m_frmSEN0104->show();
        break;
    case VDevice::GSensorSEN0105:
        ...
        m_frmSEN0105->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0105->width()),\
                                      this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0105->height()),m_frmSEN0105->width(),m_frmSEN0105->height());
        m_frmSEN0105->show();
        break;
    case VDevice::GSensorSEN0106:
        ...
        m_frmSEN0106->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0106->width()),\
                                      this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0106->height()),m_frmSEN0106->width(),m_frmSEN0106->height());
        m_frmSEN0106->show();
        break;
    case VDevice::GSensorSEN0107:
        ...
        m_frmSEN0107->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0107->width()),\
                                      this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0107->height()),m_frmSEN0107->width(),m_frmSEN0107->height());
        m_frmSEN0107->show();
        break;
    case VDevice::GSensorSEN0108:
        ...
        m_frmSEN0108->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0108->width()),\
                                      this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0108->height()),m_frmSEN0108->width(),m_frmSEN0108->height());
    ...
    case VDevice::GSensorSEN0109:
        ...
        m_frmSEN0109->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0109->width()),\
                                      this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0109->height()),m_frmSEN0109->width(),m_frmSEN0109->height());
        m_frmSEN0109->show();
        break;
    case VDevice::GSensorSEN0110:
        ...
        m_frmSEN0110->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0110->width()),\
                                  this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0110->height()),m_frmSEN0110->width(),m_frmSEN0110->height());
        m_frmSEN0110->show();
        break;
    case VDevice::GSensorSEN0111:
        ...
        m_frmSEN0111->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0111->width()),\
                                  this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0111->height()),m_frmSEN0111->width(),m_frmSEN0111->height());
        m_frmSEN0111->show();
        break;
    case VDevice::GSensorSEN0112:
        ...
        m_frmSEN0112->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0112->width()),\
                                  this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0112->height()),m_frmSEN0112->width(),m_frmSEN0112->height());
        m_frmSEN0112->show();
        break;
    case VDevice::GSensorSEN0113:
        ...
        m_frmSEN0113->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0113->width()),\
                                  this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0113->height()),m_frmSEN0113->width(),m_frmSEN0113->height());
        m_frmSEN0113->show();
        break;
    case VDevice::GSensorSEN0114:
        ...
        m_frmSEN0114->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0114->width()),\
                                      this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0114->height()),m_frmSEN0114->width(),m_frmSEN0114->height());
        m_frmSEN0114->show();
        break;
    case VDevice::GSensorSEN0115:
        ...
        m_frmSEN0115->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0115->width()),\
                                      this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0115->height()),m_frmSEN0115->width(),m_frmSEN0115->height());
        m_frmSEN0115->show();
        break;
    case VDevice::GSensorSEN0116:
        ...
        m_frmSEN0116->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0116->width()),\
                                  this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0116->height()),m_frmSEN0116->width(),m_frmSEN0116->height());
        m_frmSEN0116->show();
        break;
    case VDevice::GSensorSEN0120:
        ...
        m_frmSEN0120->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0120->width()),\
                                  this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0120->height()),m_frmSEN0120->width(),m_frmSEN0120->height());
        m_frmSEN0120->show();
        break;
    case VDevice::GSensorSEN0121:
        ...
        m_frmSEN0121->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0121->width()),\
                                  this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0121->height()),m_frmSEN0121->width(),m_frmSEN0121->height());
        m_frmSEN0121->show();
        break;
    case VDevice::GSensorSEN0150:
        ...
        m_frmSEN0150->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0150->width()),\
                                      this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0150->height()),m_frmSEN0150->width(),m_frmSEN0150->height());
        m_frmSEN0150->show();
        break;
    case VDevice::GSensorSEN0151:
        ...
        m_frmSEN0151->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0151->width()),\
                                      this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0151->height()),m_frmSEN0151->width(),m_frmSEN0151->height());
        m_frmSEN0151->show();
        break;
    case VDevice::GSensorSEN0132:
        ...
        m_frmSEN0132->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmSEN0132->width()),\
                                      this->getLocal_Y(ui->tabWidget->geometry(),m_frmSEN0132->height()),m_frmSEN0132->width(),m_frmSEN0132->height());
        m_frmSEN0132->show();
        break;
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////    MODULE   /////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    case VDevice::GModuleMOD1103:
        ...
        m_frmMOD1103->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmMOD1103->width()),\
                                  this->getLocal_Y(ui->tabWidget->geometry(),m_frmMOD1103->height()),m_frmMOD1103->width(),m_frmMOD1103->height());
        m_frmMOD1103->show();
        break;
        case VDevice::GModuleMOD0020:
            ...
            m_frmMOD0020->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmMOD0020->width()),\
                                      this->getLocal_Y(ui->tabWidget->geometry(),m_frmMOD0020->height()),m_frmMOD0020->width(),m_frmMOD0020->height());
            m_frmMOD0020->show();
            break;
            default:break;
    }
...
void MainWindow::on_selectModule1101(Module_Msg1101::MsgSystem n)
{
    ...
    case Module_Msg1101::MSG_SYSTEM_WATER:
        ...
        m_frmMOD1101->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmMOD1101->width()),\
                                  this->getLocal_Y(ui->tabWidget->geometry(),m_frmMOD1101->height()),m_frmMOD1101->width(),m_frmMOD1101->height());
        m_frmMOD1101->show();
        break;
    case Module_Msg1101::MSG_SYSTEM_SPRINGS:
        ...
        m_frmMOD1102->setGeometry(this->getLocal_X(ui->tabWidget->geometry(),m_frmMOD1102->width()),\
                                  this->getLocal_Y(ui->tabWidget->geometry(),m_frmMOD1102->height()),m_frmMOD1102->width(),m_frmMOD1102->height());
        m_frmMOD1102->show();
        break;
