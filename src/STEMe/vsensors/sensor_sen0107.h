#ifndef SENSOR_SEN0107_H
#define SENSOR_SEN0107_H
...
#include <esensor/edev_sen0107.h>
#include <vchart/vchart_zoom.h>
#include <vroot/vdevicecalibration.h>


namespace Ui {
class Sensor_SEN0107;
}

class Sensor_SEN0107 : public QWidget
{
    Q_OBJECT
    /////////////////////////////////////////////////////////////////////////////////////////////////Function for Sensor...
 public:
 ...
 private:
     ...
     EDev_Sen0107 *m_edev_sen0107=nullptr;
 ...
 private:
     ...
     void displayPoll();
 public:
     explicit Sensor_SEN0107(QWidget *parent = nullptr);
     ~Sensor_SEN0107();
 private slots:
