#ifndef SENSOR_SEN0112_H
#define SENSOR_SEN0112_H
...
#include <esensor/edev_sen0112.h>
...
namespace Ui {
class Sensor_SEN0112;
}

class Sensor_SEN0112 : public QWidget
{
    Q_OBJECT
...
private:
    ...
    EDev_Sen0112 *m_edev_sen0112=nullptr;
...
public:
    explicit Sensor_SEN0112(QWidget *parent = nullptr);
    ~Sensor_SEN0112();
...
private slots:
    ...
    void on_pushButton_getSamples_2_clicked();

    void on_comboBox_Temp_Unit_2_currentIndexChanged(int index);
