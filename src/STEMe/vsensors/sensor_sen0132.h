#ifndef SENSOR_SEN0132_H
#define SENSOR_SEN0132_H
...
#include <esensor/edev_sen0132.h>
...
namespace Ui {
class Sensor_SEN0132;
}

class Sensor_SEN0132 : public QWidget
{
    Q_OBJECT
...
private:
    ...
    EDev_Sen0132 *m_edev_sen0132=nullptr;
...
public:
    explicit Sensor_SEN0132(QWidget *parent = nullptr);
    ~Sensor_SEN0132();
