/****************************************************************************
** Meta object code from reading C++ file 'sensor_sen0107.h'
**
...
#include "../STEMe/vsensors/sensor_sen0107.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'sensor_sen0107.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_Sensor_SEN0107_t {
    QByteArrayData data[16];
    char stringdata0[360];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Sensor_SEN0107_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Sensor_SEN0107_t qt_meta_stringdata_Sensor_SEN0107 = {
    {
QT_MOC_LITERAL(0, 0, 14), // "Sensor_SEN0107"
...
QT_MOC_LITERAL(15, 330, 29) // "on_pushButton_SetZero_clicked"
    ...
    "Sensor_SEN0107\0on_displayTimer\0\0"
...
static const uint qt_meta_data_Sensor_SEN0107[] = {
...
void Sensor_SEN0107::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Sensor_SEN0107 *_t = static_cast<Sensor_SEN0107 *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Sensor_SEN0107::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Sensor_SEN0107.data,
      qt_meta_data_Sensor_SEN0107,  qt_static_metacall, nullptr, nullptr}
};


const QMetaObject *Sensor_SEN0107::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *Sensor_SEN0107::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_Sensor_SEN0107.stringdata0))
        return static_cast<void*>(this);
    return QWidget::qt_metacast(_clname);
}

int Sensor_SEN0107::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
