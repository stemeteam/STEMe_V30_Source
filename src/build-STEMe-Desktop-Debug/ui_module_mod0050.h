...
public:
    ...
    void setupUi(QWidget *Module_MOD0050)
    {
        if (Module_MOD0050->objectName().isEmpty())
            Module_MOD0050->setObjectName(QStringLiteral("Module_MOD0050"));
        Module_MOD0050->resize(331, 135);
        Module_MOD0050->setStyleSheet(QStringLiteral("background-color: #132630;"));
    ...
    {
        Module_MOD0050->setWindowTitle(QApplication::translate("Module_MOD0050", "Form", nullptr));
        radioButton_Continuously->setText(QApplication::translate("Module_MOD0050", "H\341\273\207 con l\341\272\257c l\303\262 xo", nullptr));
        radioButton_Accumulation->setText(QApplication::translate("Module_MOD0050", "H\341\273\207 \304\221o l\341\273\261c c\341\272\243n c\341\273\247a n\306\260\341\273\233c", nullptr));
        pushButton->setText(QApplication::translate("Module_MOD0050", "PushButton", nullptr));
    } // retranslateUi
