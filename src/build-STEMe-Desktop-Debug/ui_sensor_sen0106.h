/********************************************************************************
** Form generated from reading UI file 'sensor_sen0106.ui'
**
...
#ifndef UI_SENSOR_SEN0106_H
#define UI_SENSOR_SEN0106_H
...
public:
    ...
    void setupUi(QWidget *Sensor_SEN0106)
    {
        if (Sensor_SEN0106->objectName().isEmpty())
            Sensor_SEN0106->setObjectName(QStringLiteral("Sensor_SEN0106"));
        Sensor_SEN0106->resize(600, 330);
        QIcon icon;
        icon.addFile(QStringLiteral(":/image/PHS0106_Icon.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        Sensor_SEN0106->setWindowIcon(icon);
        Sensor_SEN0106->setStyleSheet(QStringLiteral("background-color: rgb(62, 97, 109);"));
        pushButton_ChartZoom = new QPushButton(Sensor_SEN0106);
        pushButton_ChartZoom->setObjectName(QStringLiteral("pushButton_ChartZoom"));
        pushButton_ChartZoom->setGeometry(QRect(11, 280, 281, 41));
        QFont font;
        font.setBold(true);
        font.setWeight(75);
        pushButton_ChartZoom->setFont(font);
        pushButton_Exit = new QPushButton(Sensor_SEN0106);
        pushButton_Exit->setObjectName(QStringLiteral("pushButton_Exit"));
        pushButton_Exit->setGeometry(QRect(320, 280, 271, 41));
        pushButton_Exit->setFont(font);
        tabWidget = new QTabWidget(Sensor_SEN0106);
...
"color:rgb(5, 209, 255)"));
        ...
        pushButton->setGeometry(QRect(10, 150, 32, 32));
...
""));
        ...
        checkBox_setMathAvg->setGeometry(QRect(10, 116, 281, 27));
        checkBox_setMathAvg->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
        label_pH_Color = new QLabel(tab_Infor_2);
        label_pH_Color->setObjectName(QStringLiteral("label_pH_Color"));
        label_pH_Color->setGeometry(QRect(110, 196, 181, 20));
        label_pH_Color->setFont(font1);
        label_pH_Color->setStyleSheet(QStringLiteral("background-color: rgb(100, 133, 201);"));
        label_pH_Color->setAlignment(Qt::AlignCenter);
        label_2 = new QLabel(tab_Infor_2);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(10, 196, 91, 22));
        QFont font3;
...
""));
        ...
        line = new QFrame(Sensor_SEN0106);
        line->setObjectName(QStringLiteral("line"));
        line->setGeometry(QRect(-2, 266, 605, 5));
        line->setStyleSheet(QStringLiteral("background-color: rgb(5, 142, 206);"));
        line->setFrameShadow(QFrame::Sunken);
        line->setFrameShape(QFrame::HLine);

        retranslateUi(Sensor_SEN0106);

        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(Sensor_SEN0106);
    } // setupUi

    void retranslateUi(QWidget *Sensor_SEN0106)
    {
        Sensor_SEN0106->setWindowTitle(QApplication::translate("Sensor_SEN0106", "Form", nullptr));
        pushButton_ChartZoom->setText(QApplication::translate("Sensor_SEN0106", "\304\220\341\273\223 th\341\273\213", nullptr));
        pushButton_Exit->setText(QApplication::translate("Sensor_SEN0106", "Tho\303\241t", nullptr));
        label_8->setText(QApplication::translate("Sensor_SEN0106", "Gi\303\241 tr\341\273\213 l\341\273\233n nh\341\272\245t", nullptr));
        label_9->setText(QApplication::translate("Sensor_SEN0106", "Gi\303\241 tr\341\273\213 trung b\303\254nh", nullptr));
        label_10->setText(QApplication::translate("Sensor_SEN0106", "Gi\303\241 tr\341\273\213 nh\341\273\217 nh\341\272\245t", nullptr));
        label_ValueMax->setText(QApplication::translate("Sensor_SEN0106", "0", nullptr));
        label_ValueAvg->setText(QApplication::translate("Sensor_SEN0106", "0", nullptr));
        label_ValueMin->setText(QApplication::translate("Sensor_SEN0106", "0", nullptr));
        comboBox_Unit->setItemText(0, QApplication::translate("Sensor_SEN0106", "\304\220o \304\221\341\273\231 pH (power of Hydrogen)", nullptr));

        pushButton->setText(QString());
        pushButton_getSamples->setText(QApplication::translate("Sensor_SEN0106", "B\341\272\257t \304\221\341\272\247u", nullptr));
        label_sampleInfo->setText(QApplication::translate("Sensor_SEN0106", "C\303\241c tham s\341\273\221 c\306\241 b\341\272\243n", nullptr));
        checkBox_setMathAvg->setText(QApplication::translate("Sensor_SEN0106", "S\341\273\255 d\341\273\245ng gi\303\241 tr\341\273\213 trung b\303\254nh c\341\273\231ng", nullptr));
        label_pH_Color->setText(QString());
        label_2->setText(QApplication::translate("Sensor_SEN0106", "Ch\341\273\211 th\341\273\213 m\303\240u", nullptr));
        checkBox_setTemperature->setText(QApplication::translate("Sensor_SEN0106", "B\303\271 nhi\341\273\207t \304\221\341\273\231 cho ph\303\251p \304\221o", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_Infor_2), QApplication::translate("Sensor_SEN0106", "            Hi\341\273\203n th\341\273\213            ", nullptr));
        label_Name->setText(QString());
        label_Address->setText(QString());
        label_SerialNumber->setText(QString());
        label_13->setText(QApplication::translate("Sensor_SEN0106", "T\303\252n thi\341\272\277t b\341\273\213:", nullptr));
        label_14->setText(QApplication::translate("Sensor_SEN0106", "\304\220\341\273\213a ch\341\273\211:", nullptr));
        label_18->setText(QApplication::translate("Sensor_SEN0106", "M\303\243 s\303\252-ri:", nullptr));
        label_19->setText(QApplication::translate("Sensor_SEN0106", "M\303\264 t\341\272\243:", nullptr));
        label_Description->setText(QString());
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("Sensor_SEN0106", "            Thi\341\272\277t b\341\273\213            ", nullptr));
        label_23->setText(QApplication::translate("Sensor_SEN0106", "(ms)", nullptr));
        label_24->setText(QApplication::translate("Sensor_SEN0106", "Th\341\273\235i gian l\341\272\245y m\341\272\253u :", nullptr));
        pushButton_SetSampleTime->setText(QApplication::translate("Sensor_SEN0106", "C\303\240i \304\221\341\272\267t", nullptr));
        pushButton_Calib->setText(QApplication::translate("Sensor_SEN0106", "Hi\341\273\207u chu\341\272\251n", nullptr));
        label_25->setText(QApplication::translate("Sensor_SEN0106", "Hi\341\273\207u chu\341\272\251n thi\341\272\277t b\341\273\213 :", nullptr));
        label_calibInfo->setText(QApplication::translate("Sensor_SEN0106", "(ch\306\260a hi\341\273\207u chu\341\272\251n)", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_6), QApplication::translate("Sensor_SEN0106", "           C\303\240i \304\221\341\272\267t            ", nullptr));
    } // retranslateUi

};

namespace Ui {
    class Sensor_SEN0106: public Ui_Sensor_SEN0106 {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_SENSOR_SEN0106_H
