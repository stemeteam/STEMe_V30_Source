...
public:
    ...
    void setupUi(QWidget *Sensor_SEN0120)
    {
        if (Sensor_SEN0120->objectName().isEmpty())
            Sensor_SEN0120->setObjectName(QStringLiteral("Sensor_SEN0120"));
        Sensor_SEN0120->resize(700, 500);
        QIcon icon;
        icon.addFile(QStringLiteral(":/image/HRS0120_Icon.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        Sensor_SEN0120->setWindowIcon(icon);
        frame = new QFrame(Sensor_SEN0120);
        frame->setObjectName(QStringLiteral("frame"));
        frame->setGeometry(QRect(0, 0, 700, 511));
        frame->setStyleSheet(QLatin1String("background-color: rgb(216, 35, 13);\n"
"background-color: rgb(170, 0, 0);"));
        ...
        radioButton_Temperature->setStyleSheet(QStringLiteral("color: rgb(255,255, 255);"));
        radioButton_Temperature->setChecked(true);
        radioButton_Temperature_2 = new QRadioButton(tab_2);
        radioButton_Temperature_2->setObjectName(QStringLiteral("radioButton_Temperature_2"));
        radioButton_Temperature_2->setGeometry(QRect(200, 211, 111, 18));
        radioButton_Temperature_2->setFont(font1);
        radioButton_Temperature_2->setStyleSheet(QStringLiteral("color: rgb(0, 255, 255);"));
...
"color: rgb(0, 0, 0);"));
        ...
        lcdNumber_HEART->setObjectName(QStringLiteral("lcdNumber_HEART"));
        lcdNumber_HEART->setGeometry(QRect(30, 25, 300, 90));
        lcdNumber_HEART->setStyleSheet(QLatin1String("background-color: #132630;\n"
"color: rgb(255, 255, 255);"));
        ...
        lcdNumber_HEART->setProperty("value", QVariant(0));
        lcdNumber_HEART->setProperty("intValue", QVariant(0));
        label_Unit_Heart = new QLabel(frame);
        label_Unit_Heart->setObjectName(QStringLiteral("label_Unit_Heart"));
        ...
        label_Unit_Heart->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
        label_Unit_Heart->setAlignment(Qt::AlignCenter);
        lcdNumber_SPO2 = new QLCDNumber(frame);
        lcdNumber_SPO2->setObjectName(QStringLiteral("lcdNumber_SPO2"));
        lcdNumber_SPO2->setEnabled(true);
        lcdNumber_SPO2->setGeometry(QRect(371, 25, 300, 90));
        lcdNumber_SPO2->setStyleSheet(QLatin1String("background-color: #132630;\n"
"color: rgb(0, 255, 255);"));
        ...
        lcdNumber_SPO2->setProperty("value", QVariant(0));
        ...
        label_Finger_Status->setObjectName(QStringLiteral("label_Finger_Status"));
        label_Finger_Status->setGeometry(QRect(30, 150, 641, 22));
        label_Finger_Status->setFont(font2);
        label_Finger_Status->setStyleSheet(QStringLiteral("color: rgb(85, 255, 127);"));
    ...
    {
        Sensor_SEN0120->setWindowTitle(QApplication::translate("Sensor_SEN0120", "Form", nullptr));
        label_4->setText(QApplication::translate("Sensor_SEN0120", "T\303\252n thi\341\272\277t b\341\273\213:", nullptr));
        label_6->setText(QApplication::translate("Sensor_SEN0120", "\304\220\341\273\213a ch\341\273\211:", nullptr));
        label_7->setText(QApplication::translate("Sensor_SEN0120", "M\303\243 s\303\252-ri:", nullptr));
        label_5->setText(QApplication::translate("Sensor_SEN0120", "M\303\264 t\341\272\243:", nullptr));
        label_Name->setText(QString());
        label_Address->setText(QString());
        label_SerialNumber->setText(QString());
        label_Description->setText(QString());
        tabWidget->setTabText(tabWidget->indexOf(tab_1), QApplication::translate("Sensor_SEN0120", "          Thi\341\272\277t b\341\273\213          ", nullptr));
        radioButton_Temperature->setText(QApplication::translate("Sensor_SEN0120", "Nh\341\273\213p tim", nullptr));
        radioButton_Temperature_2->setText(QApplication::translate("Sensor_SEN0120", "SPO2", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("Sensor_SEN0120", "          \304\220\341\273\223 th\341\273\213          ", nullptr));
        label_3->setText(QApplication::translate("Sensor_SEN0120", "Hi\341\273\207u chu\341\272\251n thi\341\272\277t b\341\273\213.", nullptr));
        pushButton_Calib_Temp->setText(QApplication::translate("Sensor_SEN0120", "Hi\341\273\207u chu\341\272\251n", nullptr));
        label_8->setText(QApplication::translate("Sensor_SEN0120", "Gi\303\241 tr\341\273\213 nh\341\273\213p tim chu\341\272\251n:", nullptr));
        label_9->setText(QApplication::translate("Sensor_SEN0120", "Gi\303\241 tr\341\273\213 SPO2 chu\341\272\251n:", nullptr));
        pushButton_Calib_Humi->setText(QApplication::translate("Sensor_SEN0120", "Hi\341\273\207u chu\341\272\251n", nullptr));
        groupBox_2->setTitle(QApplication::translate("Sensor_SEN0120", "C\303\240i \304\221\341\272\267t chung", nullptr));
        label_13->setText(QApplication::translate("Sensor_SEN0120", "Th\341\273\235i gian l\341\272\245y m\341\272\253u :", nullptr));
        label_14->setText(QApplication::translate("Sensor_SEN0120", "(ms)", nullptr));
        label_15->setText(QApplication::translate("Sensor_SEN0120", "( BPM )", nullptr));
        label_16->setText(QApplication::translate("Sensor_SEN0120", "( % )", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("Sensor_SEN0120", "          C\303\240i \304\221\341\272\267t          ", nullptr));
        label_Unit_Heart->setText(QApplication::translate("Sensor_SEN0120", "\304\220o nh\341\273\213p tim (Beats per minute - BPM)", nullptr));
        label_2->setText(QApplication::translate("Sensor_SEN0120", "\304\220o \304\221\341\273\231 b\303\243o h\303\262a Oxy trong m\303\241u (SPO2)", nullptr));
        pushButton_Apply->setText(QApplication::translate("Sensor_SEN0120", "\303\201p d\341\273\245ng", nullptr));
        pushButton_Cancel->setText(QApplication::translate("Sensor_SEN0120", "Tho\303\241t", nullptr));
        pushButton_ChartZoom->setText(QApplication::translate("Sensor_SEN0120", "Ph\303\242n t\303\255ch", nullptr));
        label_Finger_Status->setText(QApplication::translate("Sensor_SEN0120", "...", nullptr));
    } // retranslateUi
